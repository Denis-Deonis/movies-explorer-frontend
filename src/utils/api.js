...
const baseUrl = "http://api.deonis.nomoredomains.work";

export const getRegistrationUser = async ({ name, email, password }) => {
...
export const getAuthorizationUser = async ({ email, password }) => {
